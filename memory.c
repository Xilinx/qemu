...
bool memory_region_access_valid_attr(MemoryRegion *mr,
                                     hwaddr addr,
                                     unsigned size,
                                     bool is_write,
                                     MemTxAttrs attrs)
{
    ...
    if (!mr->ops->valid.accepts && !mr->ops->valid.accepts_tr) {
        return true;
    }
